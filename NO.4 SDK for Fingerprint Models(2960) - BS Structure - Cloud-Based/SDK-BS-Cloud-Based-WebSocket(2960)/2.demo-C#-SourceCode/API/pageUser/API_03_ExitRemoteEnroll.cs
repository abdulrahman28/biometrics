...
{
    class API_03_ExitRemoteEnroll
    {

        #region API_03_ExitRemoteEnroll Attributes[属性]
        ...
        #region API_03_ExitRemoteEnroll XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>ExitRemoteEnroll</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>ExitRemoteEnroll</Response>
        //<ResultCode>SuccessExitRemoteEnroll/NotStartedRemoteEnroll</ResultCode>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的ExitRemoteEnroll的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "ExitRemoteEnroll")
                {
                    ...
                    try
                    {
                        resultCode = doc.SelectSingleNode("/Message/ResultCode").InnerText;
                    }
                    catch (System.Exception) { }
