...
{
    class API_03_GetFingerData
    {
        #region API_03_GetFingerData Attributes[属性]
        ...
        {
            get { return fingerData; }
            set { fingerData = value; }
        }
        ...
        #region API_03_GetFingerData XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetFingerData</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetFingerData</Response>
        //<UserID>1</UserID>
        //<FingerNo>1</FingerNo>
        //<Duress>Yes</Duress>
        //<FingerData>04130</FingerData>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetFingerData的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetFingerData")
                {
                    ...
                    try
                    {
                        duress = doc.SelectSingleNode("/Message/Duress").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        fingerData = doc.SelectSingleNode("/Message/FingerData").InnerText;
                    }
                    catch (System.Exception) { }
