...
{
    class API_03_SetFaceDataByPicture
    {
        #region API_03_SetFaceDataByPicture Attributes[属性]
        ...
        #region API_03_SetFaceDataByPicture XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetFaceDataByPicture</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetFaceDataByPicture</Response>
        //<UserID>1</UserID>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 发送API_03_SetFaceDataByPicture指令.
        /// </summary>
        ...
        /// <summary>
        /// 解析返回的SetFaceDataByPicture的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "SetFaceDataByPicture")
                {
