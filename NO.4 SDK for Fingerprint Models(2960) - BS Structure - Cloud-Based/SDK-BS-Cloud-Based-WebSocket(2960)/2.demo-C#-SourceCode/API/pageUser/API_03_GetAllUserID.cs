...
{
    class API_03_GetAllUserID
    {

        #region API_03_GetAllUserID Attributes[属性]
        ...
        #region API_03_GetAllUserID XML指令和返回数据
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetAllUserID</Request>
        //<Ccid>2</Ccid>
        ...
        //<Response>GetAllUserID</Response>
        //<UserID>1,2,4,5</UserID>
        //<Result>OK</Result>
        //</Message>
        ...
        /// <summary>
        /// 解析返回的GetAllUserID的数据，解析成功返回true
        /// </summary>
