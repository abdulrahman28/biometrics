...
{
    class API_03_SetFingerDataByPicture
    {
        #region API_03_SetFingerDataByPicture Attributes[属性]
        ...
        private string S_pictureSize;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_PictureSize
        {
            get { return S_pictureSize; }
            set { S_pictureSize = value; }
        }

        private string S_pictureData;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_PictureData
        {
            get { return S_pictureData; }
            set { S_pictureData = value; }
        }
        ...
        #region API_03_SetFingerDataByPicture XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetFingerDataByPicture</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<UserID>1</UserID>
        //<FingerNo>1</FingerNo>
        //<PictureSize>5543</PictureSize>
        //<PictureData>Photo data</PictureData>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetFingerDataByPicture</Response>
        //<UserID>1</UserID>
        //<FingerNo>1</FingerNo>
        //<Result>OK</Result>
        //</Message>
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<PictureSize>" + S_pictureSize + "</PictureSize>\r\n" +
                          "<PictureData>" + S_pictureData + "</PictureData>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetFingerDataByPicture的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "SetFingerDataByPicture")
                {
