...
{
    class API_03_GetUserQRCode
    {
        #region API_03_GetUserQRCode Attributes[属性]
        ...
        #region API_03_GetUserQRCode XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetUserQRCode</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetUserQRCode</Response>
        //<UserID>1</UserID>
        //<QRCodeData>skh_shje55</QRCodeData>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetUserQRCode的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetUserQRCode")
                {
                    ...
                    try
                    {
                        qrCodeData = doc.SelectSingleNode("/Message/QRCodeData").InnerText;
                    }
                    catch (System.Exception) { }
