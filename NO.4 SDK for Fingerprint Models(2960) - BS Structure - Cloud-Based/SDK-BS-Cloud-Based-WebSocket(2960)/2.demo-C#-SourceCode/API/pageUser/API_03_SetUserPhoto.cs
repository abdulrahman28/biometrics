...
{
    class API_03_SetUserPhoto
    {
        #region API_03_SetUserPhoto Attributes[属性]
        ...
        private string S_photoSize;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_PhotoSize
        {
            get { return S_photoSize; }
            set { S_photoSize = value; }
        }

        private string S_photoData;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_PhotoData
        {
            get { return S_photoData; }
            set { S_photoData = value; }
        }
        ...
        #region API_03_SetUserPhoto XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetUserPhoto</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<UserID>1</UserID>
        //<PhotoSize>5543</PhotoSize>
        //<PhotoData>Photo data</PhotoData>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetUserPhoto</Response>
        //<UserID>1</UserID>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<PhotoSize>" + S_photoSize + "</PhotoSize>\r\n" +
                          "<PhotoData>" + S_photoData + "</PhotoData>\r\n" +
                          "</Message>";
