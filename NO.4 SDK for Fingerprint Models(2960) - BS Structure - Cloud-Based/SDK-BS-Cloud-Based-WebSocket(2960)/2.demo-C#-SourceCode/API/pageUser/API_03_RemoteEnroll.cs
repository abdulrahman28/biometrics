...
{
    class API_03_RemoteEnroll
    {

        #region API_03_RemoteEnroll Attributes[属性]
        ...
        private string S_backup;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_Backup
        {
            get { return S_backup; }
            set { S_backup = value; }
        }
        ...
        #region API_03_RemoteEnroll XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
