...
{
    class API_03_GetUserPassword
    {

        #region API_03_GetUserPassword Attributes[属性]
        ...
        #region API_03_GetUserPassword XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetUserPassword</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetUserPassword</Response>
        //<UserID>1</UserID>
        //<Password>4</Password>
        //<Result>OK</Result>
        //</Message>
        ...
        /// <summary>
        /// 解析返回的GetUserPassword的数据，解析成功返回true
        /// </summary>
