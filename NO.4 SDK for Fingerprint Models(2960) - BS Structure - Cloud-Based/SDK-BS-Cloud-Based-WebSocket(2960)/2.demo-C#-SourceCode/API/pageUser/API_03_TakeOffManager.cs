...
{
    class API_03_TakeOffManager
    {
        #region API_03_TakeOffManager Attributes[属性]
        ...
        #region API_03_TakeOffManager XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>TakeOffManager</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>TakeOffManager</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            //string time = shortDate + "-T" + longTime + "Z";
        ...
        /// <summary>
        /// 解析返回的TakeOffManager的数据，解析成功返回true
        /// </summary>
