...
{
    class API_03_SetFaceData
    {

        #region API_03_SetFaceData Attributes[属性]
        ...
        private string S_faceData;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_FaceData
        {
            get { return S_faceData; }
            set { S_faceData = value; }
        }
        ...
        #region API_03_SetFaceData XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetFaceData</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<UserID>1</UserID>
        //<DuplicationCheck>Yes</DuplicationCheck>
        //<FaceData>Template data in base64 encoding</FaceData>
        //</Message>
        ...
        /// <summary>
        /// 解析返回的SetFaceData的数据，解析成功返回true
        /// </summary>
