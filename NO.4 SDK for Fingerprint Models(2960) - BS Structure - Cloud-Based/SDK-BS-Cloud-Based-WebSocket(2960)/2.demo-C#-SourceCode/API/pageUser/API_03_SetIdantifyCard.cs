...
{
    class API_03_SetIdantifyCard
    {
        #region API_03_SetIdantifyCard Attributes[属性]
        ...
        /// XML字段,
        /// </summary>
        public string S_Authority
        {
            get { return S_authority; }
            set { S_authority = value; }
        }

        private string S_validDate;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_ValidDate
        {
            get { return S_validDate; }
            set { S_validDate = value; }
        }
        ...
        private string S_fingersData;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_FingersData
        {
            get { return S_fingersData; }
            set { S_fingersData = value; }
        }
        ...
        #region API_03_SetIdantifyCard XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetIdantifyCard</Request>
        //<Ccid>2</Ccid>
        ...
        //<Response>SetIdantifyCard</Response>
        //<UserID>440102199901013214</UserID>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<Nation>" + S_nation + "</Nation>\r\n" +
                          "<Birthday>" + S_birthday + "</Birthday>\r\n" +
                          "<Address>" + S_address + "</Address>\r\n" +
                          "<Authority>" + S_authority + "</Authority>\r\n" +
                          "<ValidDate>" + S_validDate + "</ValidDate>\r\n" +
                          "<Photo>" + S_photo + "</Photo>\r\n" +
                          "<FingersData>" + S_fingersData + "</FingersData>\r\n" +
                          "</Message>";
