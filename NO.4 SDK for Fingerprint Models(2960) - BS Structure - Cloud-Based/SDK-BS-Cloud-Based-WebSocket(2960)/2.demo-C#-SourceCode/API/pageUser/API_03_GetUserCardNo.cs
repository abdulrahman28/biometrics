...
{
    class API_03_GetUserCardNo
    {

        #region API_03_GetUserCardNo Attributes[属性]
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetUserCardNo</Response>
        //<UserID>1</UserID>
        //<CardNo>0</CardNo>
        //<Result>OK</Result>
        //</Message>
        ...
        /// <summary>
        /// 解析返回的GetUserCardNo的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetUserCardNo")
                {
                    ...
                    try
                    {
                        cardNo = doc.SelectSingleNode("/Message/CardNo").InnerText;
                    }
                    catch (System.Exception) { }
