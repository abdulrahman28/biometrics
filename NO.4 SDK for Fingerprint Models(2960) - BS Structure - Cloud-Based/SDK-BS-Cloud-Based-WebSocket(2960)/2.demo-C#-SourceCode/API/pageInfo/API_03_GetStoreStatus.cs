...
{
    class API_03_GetStoreStatus
    {
        #region API_03_GetStoreStatus Attributes[属性]
        ...
        {
            get { return managerCount; }
            set { managerCount = value; }
        }
        ...
        /// XML字段,
        /// </summary>
        public string PwdCount
        {
            get { return pwdCount; }
            set { pwdCount = value; }
        }
        
        private string timeLogCount;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string TimeLogCount
        {
            get { return timeLogCount; }
            set { timeLogCount = value; }
        }
        
        private string manageLogCount;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string ManageLogCount
        {
            get { return manageLogCount; }
            set { manageLogCount = value; }
        }
        
        private string photoLogCount;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string PhotoLogCount
        {
            get { return photoLogCount; }
            set { photoLogCount = value; }
        }
        ...
        #region API_03_GetStoreStatus XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetStoreStatus</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<ManagerCount>xxx-yyy</ManagerCount>
        //<UserCount>xxx-yyy</UserCount>
        //<FaceCount>xx-yyy</FaceCount>
        //<FpCount>xxx-yyy</FpCount>
        //<CardCount>xxx-yyy</CardCount>
        //<PwdCount>xxx-yyy</PwdCount>
        //<TimeLogCount>zzz-xxx-yyy</TimeLogCount>
        //<ManageLogCount>zzz-xxx-yyy</ManageLogCount>
        //<PhotoLogCount>zzz-xxx-yyy</PhotoLogCount>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetStoreStatus的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetStoreStatus")
                {
                    ...
                    try
                    {
                        managerCount = doc.SelectSingleNode("/Message/ManagerCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        userCount = doc.SelectSingleNode("/Message/UserCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        faceCount = doc.SelectSingleNode("/Message/FaceCount").InnerText;
                    }
                    catch (System.Exception) { }
                    try
                    {
                        fpCount = doc.SelectSingleNode("/Message/FpCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        cardCount = doc.SelectSingleNode("/Message/CardCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        pwdCount = doc.SelectSingleNode("/Message/PwdCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        timeLogCount = doc.SelectSingleNode("/Message/TimeLogCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        manageLogCount = doc.SelectSingleNode("/Message/ManageLogCount").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        photoLogCount = doc.SelectSingleNode("/Message/PhotoLogCount").InnerText;
                    }
                    catch (System.Exception) { }
