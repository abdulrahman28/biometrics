...
{
    class API_03_GetDeviceInfo
    {
        #region API_03_GetDeviceInfo Attributes[属性]
        ...
        #region API_03_GetDeviceInfo XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetDeviceInfo</Response>
        //<ReleasedTime>2010-4-11</ReleasedTime>
        //<ProductName>AK47</ProductName>
        //<Manufacturer>Russia</Manufacturer>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetDeviceInfo的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetDeviceInfo")
                {
                    ...
                    try
                    {
                        releasedTime = doc.SelectSingleNode("/Message/ReleasedTime").InnerText;
                    }
                    catch (System.Exception) { }
                    ...
                    try
                    {
                        manufacturer = doc.SelectSingleNode("/Message/Manufacturer").InnerText;
                    }
                    catch (System.Exception) { }
