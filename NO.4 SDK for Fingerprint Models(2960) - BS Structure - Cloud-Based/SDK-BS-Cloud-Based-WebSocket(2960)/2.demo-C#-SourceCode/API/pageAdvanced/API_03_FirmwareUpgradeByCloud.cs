...
{
    class API_03_FirmwareUpgradeByCloud
    {
        #region API_03_FirmwareUpgradeByCloud Attributes[属性]
        ...
        #region API_03_FirmwareUpgradeByCloud XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>FirmwareUpgradeByCloud</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<Action>RestoreFactory</Action>
        //<Size>41</Size>
        //<Data>http://download.realandbio.com/d/fw/v2.01</Data>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>FirmwareUpgradeByCloud</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            string size = Convert.ToString(S_data.Length);
        ...
        /// <summary>
        /// 解析返回的FirmwareUpgradeByCloud的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "FirmwareUpgradeByCloud")
                {
