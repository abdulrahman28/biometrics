...
{
    class API_03_RestoreDevice
    {
        #region API_03_RestoreDevice Attributes[属性]
        ...
        #region API_03_RestoreDevice XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>RestoreDevice</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>RestoreDevice</Response>
        //<Action>RestoreFactory</Action>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的RestoreDevice的数据，解析成功返回true
        /// </summary>
