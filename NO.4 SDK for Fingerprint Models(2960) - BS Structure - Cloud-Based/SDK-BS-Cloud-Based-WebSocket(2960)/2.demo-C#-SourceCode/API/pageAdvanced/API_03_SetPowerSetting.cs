...
{
    class API_03_SetPowerSetting
    {

        #region API_03_SetPowerSetting Attributes[属性]
        ...
        private string S_restart;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_Restart
        {
            get { return S_restart; }
            set { S_restart = value; }
        }

        private string S_restartTime;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_RestartTime
        {
            get { return S_restartTime; }
            set { S_restartTime = value; }
        }

        private string S_sleepAfter;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_SleepAfter
        {
            get { return S_sleepAfter; }
            set { S_sleepAfter = value; }
        }
        
        private string S_screenSaver;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_ScreenSaver
        {
            get { return S_screenSaver; }
            set { S_screenSaver = value; }
        }

        private string S_powerKey;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_PowerKey
        {
            get { return S_powerKey; }
            set { S_powerKey = value; }
        }
        #endregion
        ...
        #region API_03_SetPowerSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetPowerSetting</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<Restart>Yes</Restart>
        //<RestartTime>00:00</RestartTime>
        //<SleepAfter>1</SleepAfter>
        //<ScreenSaver>Yes</ScreenSaver>
        //<PowerKey>Yes</PowerKey>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetPowerSetting</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          "<Message>\r\n" +
                          "<Request>SetDeviceSetting</Request>\r\n" +
                          "<Ccid>" + strCcid + "</Ccid>\r\n" +
                          "<Time>" + time + "</Time>\r\n" +
                          "<Action_ext>" + S_action_ext + "</Action_ext>\r\n" +
                          "<Restart>" + S_restart + "</Restart>\r\n" + 
                          "<RestartTime>" + S_restartTime + "</RestartTime>\r\n" +
                          "<SleepAfter>" + S_sleepAfter + "</SleepAfter>\r\n" +
                          "<ScreenSaver>" + S_screenSaver + "</ScreenSaver>\r\n" +
                          "<PowerKey>" + S_powerKey + "</PowerKey>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetPowerSetting的数据，解析成功返回true
        /// </summary>
