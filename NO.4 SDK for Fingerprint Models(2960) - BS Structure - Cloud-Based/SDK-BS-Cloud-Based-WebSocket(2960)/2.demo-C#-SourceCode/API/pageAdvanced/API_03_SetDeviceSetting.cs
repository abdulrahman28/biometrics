...
{
    class API_03_SetDeviceSetting
    {


        #region API_03_SetDeviceSetting Attributes[属性]
        ...
        private string S_identifyMode;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_IdentifyMode
        {
            get { return S_identifyMode; }
            set { S_identifyMode = value; }
        }

        private string S_realTimePhoto;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_RealTimePhoto
        {
            get { return S_realTimePhoto; }
            set { S_realTimePhoto = value; }
        }

        private string S_livingMode;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_LivingMode
        {
            get { return S_livingMode; }
            set { S_livingMode = value; }
        }

        private string S_swipeIDCardCount;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_SwipeIDCardCount
        {
            get { return S_swipeIDCardCount; }
            set { S_swipeIDCardCount = value; }
        }
        ...
        #region API_03_SetDeviceSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetDeviceSetting</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<Language>" + S_language + "</Language>\r\n" +
                          "<Volume>" + S_volume + "</Volume>\r\n" +
                          "<IdentifyMode>" + S_identifyMode + "</IdentifyMode>\r\n" +
                          "<RealTimePhoto>" + S_realTimePhoto + "</RealTimePhoto>\r\n" +
                          "<LivingMode>" + S_livingMode + "</LivingMode>\r\n" +
                          "<SwipeIDCardCount>" + S_swipeIDCardCount + "</SwipeIDCardCount>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetDeviceSetting的数据，解析成功返回true
        /// </summary>
