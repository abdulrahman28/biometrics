...
{
    class API_03_TakePhoto
    {
        #region API_03_TakePhoto Attributes[属性]
        ...
        private string S_camera;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_Camera
        {
            get { return S_camera; }
            set { S_camera = value; }
        }
        ...
        #region API_03_TakePhoto XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        ...
        /// <summary>
        /// 解析返回的GetUserPhoto的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "TakePhoto")
                {
                    ...
                    try
                    {
                        camera = doc.SelectSingleNode("/Message/Camera").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        photoData = doc.SelectSingleNode("/Message/PhotoData").InnerText;
                    }
                    catch (System.Exception) { }
