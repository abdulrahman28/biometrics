...
{
    class API_03_SetAttendanceRule
    {
        #region API_03_SetAttendanceRule Attributes[属性]
        ...
        private string[] S_timeSection = new string[24];
        /// <summary>
        /// XML字段,
        /// </summary>
        public string[] S_TimeSection
        {
            get { return S_timeSection; }
            set { S_timeSection = value; }
        }
        #endregion
        ...
        #region API_03_SetAttendanceRule XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetAttendanceRule</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<TimeSection_0>23:42, 0, 0, 0</TimeSection_0>
        //<TimeSection_1>0, 0, 0, 0</TimeSection_1>
        //        ...
        //<TimeSection_23>0, 0, 0, 0</TimeSection_23>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetAttendanceRule</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                timeSection += "<Bell_" + i + ">" + S_timeSection[i] + "</Bell_" + i + ">\r\n";
            }
        ...
        /// <summary>
        /// 解析返回的SetAttendanceRule的数据，解析成功返回true
        /// </summary>
