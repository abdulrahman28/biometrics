...
{
    class API_03_GetAttendanceRule
    {
        #region API_03_GetAttendanceRule Attributes[属性]
        ...
        private string[] timeSection = new string[24]{ "00:00,00:00,Duty On", "00:00,00:00,Duty On", "00:00,00:00,Duty On", "00:00,00:00,Duty On", "00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On", "00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On","00:00,00:00,Duty On", "00:00,00:00,Duty On" };
        /// <summary>
        /// XML字段,
        /// </summary>
        public string[] TimeSection
        {
            get { return timeSection; }
            set { timeSection = value; }
        }

        #endregion
        #endregion

        #region API_03_GetAttendanceRule XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetAttendanceRule</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetAttendanceRule</Response>
        //<TimeSection_0>0, 0, 0</TimeSection_0>
        //<TimeSection_1>0, 0, 0</TimeSection_1>
        //<TimeSection_2>0, 0, 0</TimeSection_2>
        //...
        //<TimeSection_23>0, 0, 0</TimeSection_23>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetAttendanceRule的数据，解析成功返回true
        /// </summary>
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetAttendanceRule")
                {
                    ...
                    for (Int32 i = 0; i < 24; i++)
                    {
                        ...
                        string xpath = "/Message/TimeSection_" + str_i;
                        try
                        {
                            timeSection[i] = doc.SelectSingleNode(xpath).InnerText;
                        }
                        catch (System.Exception) { }
                    }
