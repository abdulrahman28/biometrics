...
{
    class API_03_RemoteOpen
    {
        #region API_03_RemoteOpen Attributes[属性]
        ...
        private string S_encCode;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_EncCode
        {
            get { return S_encCode; }
            set { S_encCode = value; }
        }
        #endregion
        ...
        #region API_03_RemoteOpen XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>RemoteOpen</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<EncCode>Df84.wf70kdehh</EncCode>
        //</Message>
        ...
        public string F_Request()
        {
            ...
            string string_data = strCcid + time + serialNo + userID;
            S_encCode = AESEncrypt(string_data, cloudID);//加密
