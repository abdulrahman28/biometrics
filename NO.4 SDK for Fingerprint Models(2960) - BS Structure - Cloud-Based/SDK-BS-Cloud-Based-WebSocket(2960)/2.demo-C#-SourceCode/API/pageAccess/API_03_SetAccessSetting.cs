...
{
    class API_03_SetAccessSetting
    {

        #region API_03_SetAccessSetting Attributes[属性]
        ...
        private string S_lockReleaseTime;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_LockReleaseTime
        {
            get { return S_lockReleaseTime; }
            set { S_lockReleaseTime = value; }
        }

        private string S_verifyPassLockReleaseTime;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_VerifyPassLockReleaseTime
        {
            get { return S_verifyPassLockReleaseTime; }
            set { S_verifyPassLockReleaseTime = value; }
        }
        ...
        private string S_passTime;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_PassTime
        {
            get { return S_passTime; }
            set { S_passTime = value; }
        }

        private string S_allWeek;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_AllWeek
        {
            get { return S_allWeek; }
            set { S_allWeek = value; }
        }
        ...
        /// XML字段,
        /// </summary>
        public string S_StartWeek
        {
            get { return S_startWeek; }
            set { S_startWeek = value; }
        }
        ...
        /// XML字段,
        /// </summary>
        public string S_EndWeek
        {
            get { return S_endWeek; }
            set { S_endWeek = value; }
        }

        private string S_doorOpenTimeout;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_DoorOpenTimeout
        {
            get { return S_doorOpenTimeout; }
            set { S_doorOpenTimeout = value; }
        }

        private string S_doorSensorType;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_DoorSensorType
        {
            get { return S_doorSensorType; }
            set { S_doorSensorType = value; }
        }

        private string S_duressAlarm;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_DuressAlarm
        {
            get { return S_duressAlarm; }
            set { S_duressAlarm = value; }
        }

        private string S_linkageAlarm;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_LinkageAlarm
        {
            get { return S_linkageAlarm; }
            set { S_linkageAlarm = value; }
        }

        private string S_tamperAlarm;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_TamperAlarm
        {
            get { return S_tamperAlarm; }
            set { S_tamperAlarm = value; }
        }

        private string S_blackListAlarm;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_BlackListAlarm
        {
            get { return S_blackListAlarm; }
            set { S_blackListAlarm = value; }
        }

        private string S_wgOutputFormat;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_WGOutputFormat
        {
            get { return S_wgOutputFormat; }
            set { S_wgOutputFormat = value; }
        }

        private string S_wgOutputContent;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_WGOutputContent
        {
            get { return S_wgOutputContent; }
            set { S_wgOutputContent = value; }
        }
        #endregion
        ...
        #region API_03_SetAccessSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetAccessSetting</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetAccessSetting</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<LockReleaseTime>" + S_lockReleaseTime + "</LockReleaseTime>\r\n" +
                          "<VerifyPassLockReleaseTime>" + S_verifyPassLockReleaseTime + "</VerifyPassLockReleaseTime>\r\n" +
                          "<PassTime>" + S_passTime + "</PassTime>\r\n" +
                          "<AllWeek>" + S_allWeek+ "</AllWeek>\r\n" +
                          "<StartWeek>" + S_startWeek + "</StartWeek>\r\n" +
                          "<EndWeek>" + S_endWeek + "</EndWeek>\r\n" +
                          "<DoorOpenTimeout>" + S_doorOpenTimeout + "</DoorOpenTimeout>\r\n" +
                          "<DoorSensorType>" + S_doorSensorType + "</DoorSensorType>\r\n" +
                          "<DuressAlarm>" + S_duressAlarm + "</DuressAlarm>\r\n" +
                          "<LinkageAlarm>" + S_linkageAlarm + "</LinkageAlarm>\r\n" +
                          "<TamperAlarm>" + S_tamperAlarm + "</TamperAlarm>\r\n" +
                          "<BlackListAlarm>" + S_blackListAlarm + "</BlackListAlarm>\r\n" +
                          "<WGOutputFormat>" + S_wgOutputFormat + "</WGOutputFormat>\r\n" +
                          "<WGOutputContent>" + S_wgOutputContent + "</WGOutputContent>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetAccessSetting的数据，解析成功返回true
        /// </summary>
