...
{
    class API_03_AccessStatus
    {
        #region API_03_AccessStatus Attributes[属性]
        ...
        private string lockReleaseStatus;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string LockReleaseStatus
        {
            get { return lockReleaseStatus; }
            set { lockReleaseStatus = value; }
        }

        private string doorSensoStatus;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string DoorSensoStatus
        {
            get { return doorSensoStatus; }
            set { doorSensoStatus = value; }
        }
        ...
        #region API_03_AccessStatus XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>AccessStatus</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>AccessStatus</Response>
        //<LockReleaseStatus>Yes</LockReleaseTime>
        //<DoorSensoStatus>Open</DoorSensorType>
        //<AlarmStatus>None</AlarmStatus>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的AccessStatus的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "AccessStatus")
                {
                    ...
                    try
                    {
                        lockReleaseStatus = doc.SelectSingleNode("/Message/LockReleaseStatus").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        doorSensoStatus = doc.SelectSingleNode("/Message/DoorSensoStatus").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        alarmStatus = doc.SelectSingleNode("/Message/AlarmStatus").InnerText;
                    }
                    catch (System.Exception) { }
