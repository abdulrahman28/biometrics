...
{
    class API_03_SetStreamingServer
    {
        #region API_03_SetStreamingServer Attributes[属性]
        ...
        private string S_streamingServer;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_StreamingServer
        {
            get { return S_streamingServer; }
            set { S_streamingServer = value; }
        }
        ...
        #region API_03_SetStreamingServer XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetStreamingServer</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<StreamingServer>https://streaming.real.alive</StreamingServer>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetStreamingServer</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<StreamingServer>" + S_streamingServer + "</StreamingServer>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetStreamingServer的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "SetStreamingServer")
                {
