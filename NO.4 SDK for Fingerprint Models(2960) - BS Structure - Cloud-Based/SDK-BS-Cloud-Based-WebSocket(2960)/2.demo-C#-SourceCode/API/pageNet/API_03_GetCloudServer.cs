...
{
    class API_03_GetCloudServer
    {
        #region API_03_GetCloudServer Attributes[属性]
        ...
        #region API_03_GetCloudServer XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetCloudServer</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetCloudServer</Response>
        ...
        /// <summary>
        /// 解析返回的GetCloudServer的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetCloudServer")
                {
                    ...
                    try
                    {
                        websocketServer = doc.SelectSingleNode("/Message/WebsocketServer").InnerText;
                    }
                    catch (System.Exception) { }
