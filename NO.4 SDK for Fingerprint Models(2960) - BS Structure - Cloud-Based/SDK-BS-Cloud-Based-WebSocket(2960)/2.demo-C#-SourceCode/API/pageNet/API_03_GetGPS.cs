...
namespace WebsocketWinformDemo_Standard
{
    class API_03_GetGPS
    {
        #region API_03_GetGPS Attributes[属性]
        ...
        #region API_03_GetGPS XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetGPS</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetGPS</Response>
        //<Longitude>-25.15465</Longitude>
        //<Latitude>-14.445</Latitude>
        //<SatelliteCount>19</SatelliteCount>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetGPS")
                {
                    ...
                    try
                    {
                        longitude = doc.SelectSingleNode("/Message/Longitude").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        latitude = doc.SelectSingleNode("/Message/Latitude").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        satelliteCount = doc.SelectSingleNode("/Message/SatelliteCount").InnerText;
                    }
                    catch (System.Exception) { }
