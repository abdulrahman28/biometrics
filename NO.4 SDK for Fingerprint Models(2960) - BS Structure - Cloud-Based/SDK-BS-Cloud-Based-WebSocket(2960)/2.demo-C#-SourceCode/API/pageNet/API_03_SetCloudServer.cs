...
{
    class API_03_SetCloudServer
    {
        #region API_03_SetCloudServer Attributes[属性]
        ...
        private string S_websocketServer;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_WebsocketServer
        {
            get { return S_websocketServer; }
            set { S_websocketServer = value; }
        }
        ...
        #region API_03_SetCloudServer XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetCloudServer</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<WebsocketServer>wss://ws.realadmin.cn</WebsocketServer>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetCloudServer</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<WebsocketServer>" + S_websocketServer + "</WebsocketServer>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetCloudServer的数据，解析成功返回true
        /// </summary>
