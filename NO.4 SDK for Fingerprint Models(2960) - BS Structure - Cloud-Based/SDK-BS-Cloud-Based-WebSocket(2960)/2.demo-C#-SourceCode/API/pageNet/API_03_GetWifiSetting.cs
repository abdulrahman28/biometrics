...
{
    class API_03_GetWifiSetting
    {
        #region API_03_GetWifiSetting Attributes[属性]
        ...
        #region API_03_GetWifiSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetWifiSetting</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetWifiSetting</Response>
        //<Use>Yes</Use>
        //<Port>5005</Port>
        //<SSID>WIFI host</SSID>
        //<Key>p123456</Key>
        ...
        /// <summary>
        /// 解析返回的GetWifiSetting的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetWifiSetting")
                {
                    ...
                    try
                    {
                        ssid = doc.SelectSingleNode("/Message/SSID").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        key = doc.SelectSingleNode("/Message/Key").InnerText;
                    }
                    catch (System.Exception) { }
