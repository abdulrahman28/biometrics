...
{
    class API_03_GetLocalServer
    {
        #region API_03_GetLocalServer Attributes[属性]
        ...
        {
            get { return terminalPort; }
            set { terminalPort = value; }
        }
        ...
        #region API_03_GetLocalServer XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetLocalServer</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetLocalServer</Response>
        ...
        /// <summary>
        /// 解析返回的GetLocalServer的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetLocalServer")
                {
                    ...
                    try
                    {
                        terminalPassword = doc.SelectSingleNode("/Message/TerminalPassword").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        terminalPort = doc.SelectSingleNode("/Message/TerminalPort").InnerText;
                    }
                    catch (System.Exception) { }
