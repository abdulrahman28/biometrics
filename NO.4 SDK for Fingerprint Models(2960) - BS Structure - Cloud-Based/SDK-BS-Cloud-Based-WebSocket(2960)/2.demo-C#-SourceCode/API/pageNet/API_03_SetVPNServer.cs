...
{
    class API_03_SetVPNServer
    {
        #region API_03_SetVPNServer Attributes[属性]
        ...
        private string S_vpnAddress;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_VPNAddress
        {
            get { return S_vpnAddress; }
            set { S_vpnAddress = value; }
        }
        ...
        #region API_03_SetVPNServer XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetVPNServer</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetVPNServer</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<VPNAddress>" + S_vpnAddress + "</VPNAddress>\r\n" +
                          "<Account>" + S_account + "</Account>\r\n" +
