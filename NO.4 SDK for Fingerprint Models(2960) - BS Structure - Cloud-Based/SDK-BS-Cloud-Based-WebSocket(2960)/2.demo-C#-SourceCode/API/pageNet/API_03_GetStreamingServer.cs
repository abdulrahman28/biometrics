...
{
    class API_03_GetStreamingServer
    {
        #region API_03_GetStreamingServer Attributes[属性]
        ...
        #region API_03_GetStreamingServer XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetStreamingServer</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetStreamingServer</Response>
        //<StreamingServer>wss://ws.realadmin.cn</StreamingServer>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetStreamingServer的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetStreamingServer")
                {
                    ...
                    try
                    {
                        streamingServer = doc.SelectSingleNode("/Message/StreamingServer").InnerText;
                    }
                    catch (System.Exception) { }
