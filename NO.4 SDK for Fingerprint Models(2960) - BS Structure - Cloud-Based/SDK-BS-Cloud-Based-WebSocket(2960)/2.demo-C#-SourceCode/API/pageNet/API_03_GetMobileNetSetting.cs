...
{
    class API_03_GetMobileNetSetting
    {
        #region API_03_GetMobileNetSetting Attributes[属性]
        ...
        #region API_03_GetMobileNetSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetMobileNetSetting</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetMobileNetSetting</Response>
        //<Use>Yes</Use>
        //<IP>10.25.127.12</IP>
        //<Operator>中国移动</Operator>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的GetMobileNetSetting的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetMobileNetSetting")
                {
                    ...
                    try
                    {
                        use = doc.SelectSingleNode("/Message/Use").InnerText;
                    }
                    catch (System.Exception) { }
                    ...
                    try
                    {
                        _operator = doc.SelectSingleNode("/Message/Operator").InnerText;
                    }
                    catch (System.Exception) { }
