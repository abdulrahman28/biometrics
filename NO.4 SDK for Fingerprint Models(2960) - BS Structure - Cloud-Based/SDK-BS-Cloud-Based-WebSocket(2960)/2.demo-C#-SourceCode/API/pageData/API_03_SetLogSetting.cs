...
{
    class API_03_SetLogSetting
    {
        #region API_03_SetLogSetting Attributes[属性]
        ...
        private string S_attLogWarning;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_AttLogWarning
        {
            get { return S_attLogWarning; }
            set { S_attLogWarning = value; }
        }

        private string S_managerLogWarning;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_ManagerLogWarning
        {
            get { return S_managerLogWarning; }
            set { S_managerLogWarning = value; }
        }

        private string S_reVerifyTime;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_ReVerifyTime
        {
            get { return S_reVerifyTime; }
            set { S_reVerifyTime = value; }
        }
        ...
        #region API_03_SetLogSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetLogSetting</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<AttLogWarning>1000</AttLogWarning>
        //<ManagerLogWarning>100</ManagerLogWarning>
        //<ReVerifyTime>3</ReVerifyTime>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetLogSetting</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<AttLogWarning>" + S_attLogWarning + "</AttLogWarning>\r\n" +
                          "<ManagerLogWarning>" + S_managerLogWarning + "</ManagerLogWarning>\r\n" +
                          "<ReVerifyTime>" + S_reVerifyTime + "</ReVerifyTime>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的SetLogSetting的数据，解析成功返回true
        /// </summary>
