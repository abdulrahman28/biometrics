...
{
    class API_03_GetNextGlog
    {
        #region API_03_GetNextGlog Attributes[属性]
        ...
        #region API_03_GetNextGlog XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        ...
        /// <summary>
        /// 解析返回的GetNextGlog的数据，解析成功返回true
        /// </summary>
