...
{
    class API_03_EmptyManageLog
    {
        #region API_03_EmptyManageLog Attributes[属性]
        ...
        private string S_compulsion;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_Compulsion
        {
            get { return S_compulsion; }
            set { S_compulsion = value; }
        }
        #endregion
        ...
        #region API_03_EmptyManageLog XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>EmptyManageLog</Request>
        //<Ccid>2</Ccid>
        //<Time>2013-4-11-T11:28:54Z</Time>
        //<Action_ext>show/xx<Action_ext>
        //<Compulsion>Yes/No</Compulsion>
        //</Message>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>EmptyManageLog</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public string F_Request()
        {
            ...
            requestXMLMassage = "<?xml version=\"1.0\"?>\r\n" +
                          ...
                          "<Compulsion>" + S_compulsion + "</Compulsion>\r\n" +
                          "</Message>";
        ...
        /// <summary>
        /// 解析返回的EmptyManageLog的数据，解析成功返回true
        /// </summary>
