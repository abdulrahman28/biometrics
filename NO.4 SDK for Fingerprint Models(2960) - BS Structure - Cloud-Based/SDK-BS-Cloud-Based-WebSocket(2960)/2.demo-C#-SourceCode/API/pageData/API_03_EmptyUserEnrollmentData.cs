...
{
    class API_03_EmptyUserEnrollmentData
    {
        #region API_03_EmptyUserEnrollmentData Attributes[属性]
        ...
        #region API_03_EmptyUserEnrollmentData XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>EmptyUserEnrollmentData</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>EmptyUserEnrollmentData</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的EmptyUserEnrollmentData的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "EmptyUserEnrollmentData")
                {
