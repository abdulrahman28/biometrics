...
{
    class API_03_EmptyTimeLog
    {
        #region API_03_EmptyTimeLog Attributes[属性]
        ...
        #region API_03_EmptyTimeLog XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>EmptyTimeLog</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>EmptyTimeLog</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的EmptyTimeLog的数据，解析成功返回true
        /// </summary>
