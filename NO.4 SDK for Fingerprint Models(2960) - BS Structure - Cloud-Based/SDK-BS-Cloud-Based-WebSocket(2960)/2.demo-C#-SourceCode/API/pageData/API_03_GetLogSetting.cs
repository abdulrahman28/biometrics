...
{
    class API_03_GetLogSetting
    {
        #region API_03_GetLogSetting Attributes[属性]
        ...
        private string attLogWarning;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string AttLogWarning
        {
            get { return attLogWarning; }
            set { attLogWarning = value; }
        }

        private string managerLogWarning;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string ManagerLogWarning
        {
            get { return managerLogWarning; }
            set { managerLogWarning = value; }
        }
        ...
        {
            get { return reVerifyTime; }
            set { reVerifyTime = value; }
        }
        ...
        #region API_03_GetLogSetting XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetLogSetting</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetLogSetting</Response>
        ...
        /// <summary>
        /// 解析返回的GetLogSetting的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetLogSetting")
                {
                    ...
                    try
                    {
                        attLogWarning = doc.SelectSingleNode("/Message/AttLogWarning").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        managerLogWarning = doc.SelectSingleNode("/Message/ManagerLogWarning").InnerText;
                    }
                    catch (System.Exception) { }

                    try
                    {
                        reVerifyTime = doc.SelectSingleNode("/Message/ReVerifyTime").InnerText;
                    }
                    catch (System.Exception) { }
