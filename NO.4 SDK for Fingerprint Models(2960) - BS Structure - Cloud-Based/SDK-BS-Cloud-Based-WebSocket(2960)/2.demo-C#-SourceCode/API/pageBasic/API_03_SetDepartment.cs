...
{
    class API_03_SetDepartment
    {
        #region API_03_SetDepartment Attributes[属性]
        ...
        #region API_03_SetDepartment XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetDepartment</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>SetDepartment</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的SetDepartment的数据，解析成功返回true
        /// </summary>
