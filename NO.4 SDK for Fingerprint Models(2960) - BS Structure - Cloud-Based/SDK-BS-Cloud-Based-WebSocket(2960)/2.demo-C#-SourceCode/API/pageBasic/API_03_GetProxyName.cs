...
{
    class API_03_GetProxyName
    {
        #region API_03_GetProxyName Attributes[属性]
        ...
        private string S_proxyNo;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_ProxyNo
        {
            get { return S_proxyNo; }
            set { S_proxyNo = value; }
        }
        ...
        #region API_03_GetProxyName XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetProxyName</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetProxyName</Response>
        //<ProxyNo>0</ProxyNo>
        //<Name></Name>
        //<Use>Yes<Use>
        //<Result>OK</Result>
        ...
        /// <summary>
        /// 解析返回的GetProxyName的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetProxyName")
                {
                    ...
                    try
                    {
                        deptNo = doc.SelectSingleNode("/Message/ProxyNo").InnerText;
                    }
                    catch (System.Exception) { }
