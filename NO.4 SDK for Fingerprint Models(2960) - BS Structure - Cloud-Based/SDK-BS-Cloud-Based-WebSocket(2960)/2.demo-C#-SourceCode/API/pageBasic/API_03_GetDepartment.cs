...
{
    class API_03_GetDepartment
    {
        #region API_03_GetDepartment Attributes[属性]
        ...
        #region API_03_GetDepartment XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetDepartment</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetDepartment</Response>
        //<DeptNo>0</DeptNo>
        //<Name></Name>
        //<Result>OK</Result>
        //</Message>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetDepartment")
                {
                    ...
                    try
                    {
                        deptNo = doc.SelectSingleNode("/Message/DeptNo").InnerText;
                    }
                    catch (System.Exception) { }
