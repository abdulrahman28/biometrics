...
{
    class API_03_EnableDevice
    {
        #region API_03_EnableDevice Attributes[属性]
        ...
        #region API_03_EnableDevice XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>EnableDevice</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>EnableDevice</Response>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        /// <summary>
        /// 解析返回的EnableDevice的数据，解析成功返回true
        /// </summary>
