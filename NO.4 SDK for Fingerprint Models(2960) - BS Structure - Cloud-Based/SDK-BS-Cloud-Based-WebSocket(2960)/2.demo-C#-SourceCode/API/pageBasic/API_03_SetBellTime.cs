...
{
    class API_03_SetBellTime
    {

        #region API_03_SetBellTime Attributes[属性]
        ...
        private string[] S_bell = new string[24];
        /// <summary>
        /// XML字段,
        /// </summary>
        public string[] S_Bell
        {
            get { return S_bell; }
            set { S_bell = value; }
        }
        ...
        #region API_03_SetBellTime XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetBellTime</Request>
        //<Ccid>2</Ccid>
        ...
        /// <summary>
        /// 解析返回的SetBellTime的数据，解析成功返回true
        /// </summary>
