...
{
    class API_03_GetNameList
    {
        #region API_03_GetNameList Attributes[属性]
        ...
        #region API_03_GetNameList XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        ...
        /// <summary>
        /// 解析返回的GetNameList的数据，解析成功返回true
        /// </summary>
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetNameList")
                {
                    ...
                    try
                    {
                        listNo = doc.SelectSingleNode("/Message/ListNo").InnerText;
                    }
                    catch (System.Exception) { }
