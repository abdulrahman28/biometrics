...
{
    class API_03_SetNameList
    {
        #region API_03_SetNameList Attributes[属性]
        ...
        private string S_listNo;
        /// <summary>
        /// XML字段,
        /// </summary>
        public string S_ListNo
        {
            get { return S_listNo; }
            set { S_listNo = value; }
        }
        ...
        #region API_03_SetNameList XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>SetNameList</Request>
        //<Ccid>2</Ccid>
        ...
        /// <summary>
        /// 解析返回的SetNameList的数据，解析成功返回true
        /// </summary>
