...
{
    class API_03_GetTime
    {
        #region API_03_GetTime Attributes[属性]
        ...
        #region API_03_GetTime XML解析Function[方法]
        /// **********************************
        //<?xml version="1.0"?>
        //<Message>
        //<Request>GetTime</Request>
        //<Ccid>2</Ccid>
        ...
        //<Action_ext>show/xx</Action_ext>
        //<Response>GetTime</Response>
        //<Time>2013-4-11-T11:31:18Z</Time>
        //<UTC>+8:00</UTC>
        //<Result>OK</Result>
        //</Message>
        ///***************************************
        ...
        public bool F_Response(string ResponseMessage)
        {
            ...
            if (ResponseMessage != null)
            {
                ...
                if (response == "GetTime")
                {
                    ...
                    try
                    {
                        utc = doc.SelectSingleNode("/Message/UTC").InnerText;
                    }
                    catch (System.Exception) { }
